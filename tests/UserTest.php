...
class UserTest extends TestCase
{
   ...
   {
    $zombieGame = $this->createMock(Game::class); //this means the instance of test case
       $zombieGame->method('getGenreCode')->willReturn('zombies');
       
       $shooterGame = $this->createMock(Game::class); //this means the instance of test case
       ...
       $ratings = $user->findRatingsByGenre('zombies'); //calling actual function
